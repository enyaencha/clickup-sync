-- Manual Migration Script for Activities Table
-- Run this in MySQL to add all missing columns
-- Note: Will error on columns that already exist - this is expected and safe to ignore
...
-- Facilitators/Staff
ALTER TABLE activities ADD COLUMN facilitators TEXT NULL;
...
-- Audit
ALTER TABLE activities ADD COLUMN created_by INT NULL;
