        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Track SMART indicators for your logframe</p>
            </div>
            <button
        ...
        <div className="grid gap-4">
          {indicators.length === 0 ? (
            ...
            indicators.map((indicator) => (
              <div key={indicator.id} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{indicator.baseline_value} {indicator.unit_of_measure}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Current</p>
                        <p className="font-medium">{indicator.current_value} {indicator.unit_of_measure}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Target</p>
                        <p className="font-medium">{indicator.target_value} {indicator.unit_of_measure}</p>
                      </div>
                    </div>
