...
const AddSubProgramModal: React.FC<AddSubProgramModalProps> = ({
  isOpen,
  onClose,
  programId,
  onSuccess,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || 'Failed to create sub-program');
      }
