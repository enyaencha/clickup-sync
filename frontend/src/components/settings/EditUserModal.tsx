  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="relative px-6 py-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-indigo-100 text-sm">Update user account information and permissions</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="px-6 py-6 space-y-6">
            ...
            {/* User ID Badge */}
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-slate-50 border-2 border-gray-200 rounded-xl">
              <div className="flex items-center space-x-3">
              ...
              <span className="px-3 py-1 bg-gradient-to-r from-gray-600 to-slate-600 text-white text-xs font-bold rounded-full">
                ID: {user.id}
              </span>
            </div>
              ...
              <div className="mb-4 p-4 bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 rounded-xl">
                <label className="flex items-start cursor-pointer group">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-600 mt-1">Grant unrestricted system access and configuration rights</p>
                  </div>
                </label>
              </div>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 flex-1">
                        <div className="text-sm font-bold text-gray-900">{role.display_name}</div>
                        <div className="text-xs text-gray-600 mt-0.5 line-clamp-2">{role.description}</div>
            ...
            <div>
              ...
              <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl">
                <label className="flex items-center cursor-pointer group">
                  ...
                  />
                  <div className="ml-3">
                    <span className="text-sm font-bold text-gray-900">Active User Account</span>
                    <p className="text-xs text-gray-600 mt-0.5">User can login and access the system</p>
                  </div>
                </label>
              </div>
            </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col-reverse sm:flex-row justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg flex items-center justify-center space-x-2"
            >
              {loading ? (
                <>
