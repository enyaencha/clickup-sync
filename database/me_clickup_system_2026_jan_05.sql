...
) ENGINE=InnoDB AUTO_INCREMENT=153 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Audit log for access control and RLS';
...
INSERT INTO `program_budgets` (`id`, `program_module_id`, `sub_program_id`, `fiscal_year`, `total_budget`, `allocated_budget`, `spent_budget`, `committed_budget`, `operational_budget`, `program_budget`, `capital_budget`, `donor`, `funding_source`, `grant_number`, `budget_start_date`, `budget_end_date`, `status`, `approval_status`, `submitted_by`, `submitted_at`, `approved_by`, `approved_at`, `notes`, `created_at`, `updated_at`, `deleted_at`) VALUES (1,2,NULL,'2026',30000000.00,0.00,0.00,0.00,NULL,20000000.00,20000000.00,'CDC','USA','5648','2026-01-01','2026-03-31','submitted','pending',1,'2025-12-31 19:10:49',NULL,NULL,'added','2025-12-31 19:10:49','2025-12-31 19:10:49',NULL),(5,2,NULL,'2025',1000000.00,0.00,0.00,0.00,100000.00,100000.00,1000000.00,'CDC','USA','564867','2025-11-04','2025-12-30','submitted','pending',1,'2025-12-31 21:27:12',NULL,NULL,'','2025-12-31 21:27:12','2025-12-31 21:27:12',NULL),(6,5,1,'2026',12000000.00,0.00,0.00,0.00,12000000.00,NULL,NULL,'','','','2026-01-01','2026-03-31','submitted','pending',1,'2025-12-31 21:39:23',NULL,NULL,'','2025-12-31 21:39:23','2025-12-31 21:39:23',NULL);
...
INSERT INTO `resource_requests` VALUES (1,'REQ-1767221070541-29',2,NULL,1,5,NULL,'maintenance',1,'dtt','2026-01-01','2026-01-02',1,'approved','urgent',1,'2026-01-05 16:31:43',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2025-12-31 22:44:30','2026-01-05 16:31:43',NULL);
...
INSERT INTO `resources` VALUES (1,'RES-1766079429500-930',5,'Vehicle','vehicle','vehicle','2025-12-18',NULL,'','','trdjkk','toyota','toyota',1,'units','main office','',NULL,NULL,NULL,'good',NULL,NULL,NULL,'available',5000000.00,NULL,NULL,NULL,NULL,NULL,1,'2025-12-18 17:37:09','2025-12-18 17:37:09',NULL),(2,'RES-1767206675691-748',5,'Prado TX KCC 568P','car','vehicle','2025-01-26',8000000.00,'purchase','Toyota Kenya','test2345','Toyota','Toyota',1,'units','office','office',NULL,NULL,NULL,'excellent',NULL,NULL,NULL,'available',5000000.00,NULL,NULL,NULL,NULL,NULL,1,'2025-12-31 18:44:35','2025-12-31 18:44:35',NULL),(3,'RES-1767631078705-558',1,'HP laptop','HP elite book','equipment','2026-01-06',50000.00,'','enmsoft','65tyr45','hp','hp',1,'units','main office','',NULL,NULL,NULL,'excellent',NULL,NULL,NULL,'available',50000.00,NULL,NULL,NULL,NULL,NULL,1,'2026-01-05 16:37:58','2026-01-05 17:33:16',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='User access to specific modules (RLS)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_module_assignments` VALUES (14,6,5,1,0,0,0,0,1,'2025-12-15 17:56:34'),(15,4,1,1,1,1,1,1,2,'2026-01-05 09:39:41'),(17,5,5,1,0,0,0,1,2,'2026-01-05 10:02:57'),(18,5,4,1,1,1,1,1,2,'2026-01-05 10:02:57'),(19,5,3,1,1,1,1,1,2,'2026-01-05 10:02:57');
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Maps users to their roles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_roles` VALUES (1,1,1,1,'2025-12-02 04:48:26',NULL),(23,3,11,1,'2025-12-04 10:22:00',NULL),(27,6,30,1,'2025-12-15 17:56:34',NULL),(28,4,11,2,'2026-01-05 09:39:41',NULL),(29,4,8,2,'2026-01-05 09:39:41',NULL),(30,5,6,2,'2026-01-05 10:02:57',NULL),(31,5,16,2,'2026-01-05 10:02:57',NULL),(32,7,8,2,'2026-01-05 10:11:05',NULL),(33,7,23,2,'2026-01-05 10:11:05',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Active user sessions and JWT tokens';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,NULL,'admin','admin@gmail.com','$2a$10$KdsBLq.abN5f1C6xGHoz9OAJ6SGL4D2IWrRYcZe.rhI3JyY.4vkfS','System Administrator',NULL,'admin',NULL,1,1,'pending',NULL,'2026-01-05 14:27:08','2025-12-02 04:48:26','2026-01-05 11:27:08',NULL),(2,NULL,'director','director@gmail.com','$2a$10$cW7xFdTMcMZq2OBLZ0dipuFS0Yw..qH15IWRQkCyCaCTZqkpF412u','me director',NULL,'field_officer',NULL,1,1,'pending',NULL,'2026-01-05 13:25:17','2025-12-02 14:08:57','2026-01-05 10:25:17',NULL),(3,NULL,'Data','data@gmail.com','$2a$10$vNqTLFPEfzfpbsJ.SjdtiuDk5erJGYv7H4gD9LxKpV2zmpWbEsacS','Data Entry Clerk',NULL,'field_officer',NULL,1,0,'pending',NULL,'2026-01-05 12:57:13','2025-12-02 17:10:24','2026-01-05 09:57:13',NULL),(4,NULL,'role','base@gmail.com','$2a$10$mfdo/ED13yKaJPiArJWESuzJWQJ5vZRTukl5vclC1sbSuwWHBc2CW','base',NULL,'field_officer',NULL,1,0,'pending',NULL,'2026-01-05 13:26:19','2025-12-02 17:50:55','2026-01-05 10:26:19',NULL),(5,NULL,'Linnet','linnet@gmail.com','$2a$10$2UmuVkjIH6nXuZhp1CQb7.p5FZlBjiKqNNtURNai3hXt4hY3l5LsC','Linnet Linnet',NULL,'field_officer',NULL,1,0,'pending',NULL,'2026-01-05 13:17:05','2025-12-03 18:48:51','2026-01-05 10:17:05',NULL),(6,NULL,'Approver','approver@gmail.com','$2a$10$WEyB/HNunHv2yjX/D53z1OZVfxcbF0nmj9MXcLDGnxZy8BbQoopti','Approver Approver ',NULL,'field_officer',NULL,1,0,'pending',NULL,'2026-01-05 13:44:11','2025-12-09 04:42:42','2026-01-05 10:44:11',NULL),(7,NULL,'module','moduleviewer@gmail.com','$2a$10$HBxD6T4kO4Jg/0niyKyNyeWZ/n1hLQu6a.vsvhJmx3ZRPCa0v/ZSW','Module Viewer',NULL,'field_officer',NULL,1,0,'pending',NULL,'2026-01-05 13:11:30','2025-12-09 04:59:15','2026-01-05 10:11:30',NULL);
...
-- Dump completed on 2026-01-05 20:37:04
